...
/// active : 21347079
/// critical : 37880
/// casesPerOneMillion : 89502
/// deathsPerOneMillion : 890
/// tests : 7008741431
/// testsPerOneMillion : 882164.71
/// population : 7944935131
/// oneCasePerPeople : 0
/// oneDeathPerPeople : 0
/// oneTestPerPeople : 0
/// activePerOneMillion : 2686.88
/// recoveredPerOneMillion : 84250.13
...
class Worldstate {
  ...
  Worldstate.fromJson(dynamic json) {
...
Worldstate copyWith({  num? updated,
  num? cases,
  num? todayCases,
  num? deaths,
  num? todayDeaths,
  ...
  num? criticalPerOneMillion,
  num? affectedCountries,
}) => Worldstate(  updated: updated ?? _updated,
  cases: cases ?? _cases,
